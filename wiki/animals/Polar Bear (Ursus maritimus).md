...
<style>
/* Two-column layout using data attribute; avoids class selectors */
[data-twocol] {
  width: 100%;
  overflow: hidden;
  margin: 1em 0;
...
/* Column distribution: left | spacer | right */
[data-twocol] > div:nth-child(1) {
  float: left;
  width: 48%;
  line-height: 1.6;
}

[data-twocol] > div:nth-child(2) {
  float: left;
  width: 4%;
}

[data-twocol] > div:nth-child(3) {
  float: left;
  width: 48%;
  text-align: center;
}
...
/* Slightly different image styling for right column */
[data-twocol] > div:nth-child(3) img {
  border-radius: 10px;
  padding: 6px;
  max-width: 90%;
}
